...
model2 = get_model(model_name="resnet", optimizer="adam", loss_fn="binary_crossentropy",training_mode=False)
...
# %%
# so how can we get such different numbers from model.evaluate()
model.trainable
# %%
