#%%
# this was using my data loader functions from geotiff into tf.Dataset.. we are using Ates data export->tfrecord->load tf.Dataset workflow now
# which is in 
...
model = get_model('simple_model_sigmoid_onehot')
print(model.summary())
#%%
# Model training
